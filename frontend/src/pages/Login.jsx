      ...
      <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#09696863] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
        ...
        <form className='w-[90%] h-[90%] flex flex-col items-center' action="">
            ...
            <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                ...
                {show ? (
                <IoEye className='w-[20px] h-[20px] right-[5%] cursor-pointer absolute bottom-[55%]' onClick={() => setShow(false)}/>
                ) : (
                <MdOutlineRemoveRedEye className='w-[20px] h-[20px] right-[5%] cursor-pointer absolute bottom-[55%]'
                ...
                <p className='flex gap-[10px]'>You have't any account? <span className='text-[#5555f6cf] text-[17px] font-semibold cursor-pointer' onClick={()=>navigate('/signup')}>SignUp</span></p>
            </div>
